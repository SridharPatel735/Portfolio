        ...
        <BackgroundLines className="flex items-center justify-center w-full flex-col px-2 pt-20">
          <div className="flex justify-center relative my-20 z-30">
            <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-[89vw] md:max-w-2xl lg:max-w-[60vw]">
              <div className="w-full md:w-4/12 flex justify-center pt-4 md:pt-10">
                <img
                  src="./mainImg.png"
                  alt="Description of image"
                  className="max-w-full h-auto object-contain md:object-cover hero-image"
                  style={{ marginTop: '150px' }}
                />
              </div>
              <div className="w-full md:w-8/12 flex flex-col items-start justify-center md:pl-4">
                <p className="uppercase tracking-widest text-[30px] md:text-2xl lg:text-2xl whitespace-normal md:whitespace-nowrap text-left text-blue-100 max-w-80 mb-4">
                ...
                <p className="pt-4 text-left md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
